          ...
          <tbody>
            ...
            <tr class="cart-product">
              <td class="product-identification">
                <img src="https://tse1.mm.bing.net/th?id=OIP.dE8ePEoXPFaVjLugh6IRswHaHa&pid=Api&P=0&h=180" alt="Miniatura" class="cart-product-image">
                <strong class="cart-product-title">AIR FORCE BRANCO</strong>
              </td>
              <td>
                <span class="cart-product-price">R$259,99</span>
              </td>
              <td>
            ...
            <tr class="cart-product">
              <td class="product-identification">
                <img src="https://tse4.mm.bing.net/th?id=OIP.lZ3ow0VUBmSohKf4-wIPzgHaEQ&pid=Api&P=0&h=180" alt="Poster 3" class="cart-product-image">
                <strong class="cart-product-title">AIR FORCE BRANCO AZUL BEBÊ</strong>
              </td>
              <td>
                <span class="cart-product-price">R$259,99</span>
              </td>
